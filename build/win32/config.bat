...
set SDL2ImageBinDir=source\Depends\SDL2_image\lib\win32\%SDL2LibArch%
set SDL2MixerBinDir=source\Depends\SDL2_mixer\lib\win32\%SDL2LibArch%

set IncludeDirs=-I source\Depends\SDL2\include\SDL2 -I source\Depends\SDL2\include -I source\Depends\SDL2_image\include -I source\Depends\SDL2_mixer\include
set LibraryDirs=-libpath:%SDL2BinDir% -libpath:%SDL2ImageBinDir% -libpath:%SDL2MixerBinDir%
